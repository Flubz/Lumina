    ...
    public class Camera2DFollow : MonoBehaviour
    {
        ...
        private void Update ()
        {
            ...
            else
            {
                ...
                bool updateLookAheadTargetZ = Mathf.Abs (zMoveDelta) > lookAheadMoveThreshold;

                if (updateLookAheadTargetX || updateLookAheadTargetZ && transform != null)
                {
                    m_LookAheadPos = (Vector3) target.transform.forward * lookAheadFactor;
                }
                else
